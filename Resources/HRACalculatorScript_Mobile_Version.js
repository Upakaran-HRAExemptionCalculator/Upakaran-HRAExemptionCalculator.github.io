	...
	//	var previousOrientation = window.orientation;
		...
		function checkOrientationAndAdjustOnLoad(){
			console.log("checkOrientationAndAdjustOnLoad called");
				...
				{  
					...
					case 90:	
								...
								document.getElementsByName("firstHeading")[0].style.fontSize =  '4vw'  // 'xx-large';
								document.getElementsByName("secondHeading")[0].style.fontSize = '3vw'  // 'large';
								document.getElementsByName("thirdHeading")[0].style.fontSize =  '3vw'  // 'large';
								document.getElementsByName("tips")[0].style.fontSize =  '2vw'  // 'medium';
								document.getElementById("downloadGuide").style.fontSize =  '2vw'  // 'medium';
								document.getElementById("tryDownload").style.fontSize =  '2vw'  // 'medium';
								...
								document.getElementsByName("developerInfo")[0].style.fontSize =  '2vw'// 'medium';
								
								document.getElementsByName("footer")[0].style.fontSize = '1.7vw' // 'smaller';
					break; 
					default:
								
								console.log("portrait");
								console.log("device held vertically.");
								document.getElementsByName("firstHeading")[0].style.fontSize = '4vw' // 'larger';
								document.getElementsByName("secondHeading")[0].style.fontSize = '3vw' // 'small';
								document.getElementsByName("thirdHeading")[0].style.fontSize = '3vw'  // 'small';
								document.getElementsByName("tips")[0].style.fontSize = '2vw'  // 'x-small';
								document.getElementById("downloadGuide").style.fontSize =  '2vw'  //'x-small';
								document.getElementById("tryDownload").style.fontSize =  '2vw'  // 'x-small';
								...
								document.getElementsByName("developerInfo")[0].style.fontSize = '2vw'// 'x-small';
								
								document.getElementsByName("footer")[0].style.fontSize = '1.7vw' // 'xx-small';
					break; 
				}
			}
			...
			console.log("doOnScreenOrientationChange called");
						...
						var orientation = screen.orientation.type;  // use this in next try
		...
		//	window.addEventListener("deviceorientation", handleOrientation, false);
						...
						if(currentOrientation != previousOrientation && currentOrientation.includes("landscape")  && orientationOnLastLoad.includes("portrait")){
						 ...
						 if(currentOrientation != previousOrientation && currentOrientation.includes("portrait") && orientationOnLastLoad.includes("landscape")){
							...
							/*	document.getElementsByName("tips")[0].style.fontSize = 'x-small';
								document.getElementById("downloadGuide").style.fontSize = 'x-small';
								document.getElementById("tryDownload").style.fontSize = 'x-small'; */
								document.getElementsByName("tips")[0].style.fontSize = 'large'; // medium
								document.getElementById("downloadGuide").style.fontSize = 'large'; // medium
								document.getElementById("tryDownload").style.fontSize = 'large'; // medium
								document.getElementsByName("YourName")[0].style.fontSize = 'medium';
								document.getElementsByName("YourName")[0].style.width = '260px';
								document.getElementsByName("FY")[0].style.fontSize = 'medium';
								document.getElementsByName("FY")[0].style.width = '160px';
								document.getElementsByName("generatePDF")[0].style.fontSize = 'medium';
							//	document.getElementsByName("developerInfo")[0].style.fontSize = 'x-small';
								document.getElementsByName("developerInfo")[0].style.fontSize = 'large'; // medium
								document.getElementsByName("footer")[0].style.fontSize = 'xx-small';
								previousOrientation = "portrait";
			...
			function handleOrientationOnHideAlert(){
				var currentOrientation = "";
							...
							if(currentOrientation.includes("landscape")  && orientationOnLastLoad.includes("portrait")){
								console.log("landscape");
								console.log("device held horizontally.");
								document.getElementsByName("firstHeading")[0].style.fontSize = 'xx-large';
								document.getElementsByName("secondHeading")[0].style.fontSize = 'large';
						...
						if(currentOrientation.includes("portrait") && orientationOnLastLoad.includes("landscape")){
								console.log("portrait");
								console.log("device held vertically.");
