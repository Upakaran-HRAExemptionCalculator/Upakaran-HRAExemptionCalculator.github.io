			...
			console.log("checkOrientationAndAdjustOnLoad called");
				...
				{  
					...
					case 90:	
								...
								document.getElementsByName("tips")[0].style.fontSize =  '3vw'  // 'medium';
								document.getElementById("downloadGuide").style.fontSize =  '3vw'  // 'medium';
								document.getElementById("tryDownload").style.fontSize =  '3vw'  // 'medium';
								...
								document.getElementsByName("developerInfo")[0].style.fontSize =  '3vw'// 'medium';
					...
					default:
								...
								document.getElementsByName("tips")[0].style.fontSize = '3vw'  // 'x-small';
								document.getElementById("downloadGuide").style.fontSize =  '3vw'  //'x-small';
								document.getElementById("tryDownload").style.fontSize =  '3vw'  // 'x-small';
								...
								document.getElementsByName("developerInfo")[0].style.fontSize = '3vw'// 'x-small';
